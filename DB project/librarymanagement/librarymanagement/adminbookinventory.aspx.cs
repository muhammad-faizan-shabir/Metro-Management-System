...
namespace librarymanagement
{
    public partial class adminbookinventory : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>alert('Book Already Exists, try some other Book.');</script>");
            }
            else 
            {
                addNewBook();
        ...
        void getBookByID()
        {
            try
            {
                ...
                if (dt.Rows.Count >= 1)
                {
                    TextBox4.Text = dt.Rows[0]["book_name"].ToString();        // book name
                    DropDownList1.SelectedValue = dt.Rows[0]["language"].ToString().Trim(); // language
                    DropDownList3.SelectedValue = dt.Rows[0]["author_name"].ToString().Trim(); // author name
                    DropDownList2.SelectedValue = dt.Rows[0]["publisher_name"].ToString().Trim(); // publisher name
                    TextBox1.Text = dt.Rows[0]["publish_date"].ToString(); //publish_date

                    ListBox1.ClearSelection();                                        // genre
                    ...
                    TextBox8.Text = dt.Rows[0]["edition"].ToString(); // edition
                    
                    TextBox9.Text = dt.Rows[0]["book_cost"].ToString().Trim(); // book_cost
                    
                    TextBox10.Text = dt.Rows[0]["no_of_pages"].ToString().Trim(); // no_of_pages
                    TextBox2.Text = dt.Rows[0]["actual_stock"].ToString().Trim(); // actual_stock
                    TextBox5.Text = dt.Rows[0]["current_stock"].ToString().Trim(); // current_stock
                    TextBox7.Text = "" + (Convert.ToInt32(dt.Rows[0]["actual_stock"].ToString()) - Convert.ToInt32(dt.Rows[0]["current_stock"].ToString()));
                    TextBox6.Text = dt.Rows[0]["book_description"].ToString(); // book_description
