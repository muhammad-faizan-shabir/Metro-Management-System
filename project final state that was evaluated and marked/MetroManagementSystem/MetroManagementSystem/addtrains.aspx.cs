    ...
    public partial class addtrains : System.Web.UI.Page
    {
        ...
        void addNewTrain()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO train_master_tbl(train_id,from_station,to_station,start_time,end_time,date,price) values(@train_id,@from_station,@to_station,@start_time,@end_time,@date,@price)", con);
