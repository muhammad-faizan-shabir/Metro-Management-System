<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="ComplaintsAndQueries.aspx.cs" Inherits="MetroManagementSystem.ComplaintsAndQueries" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="text mb-4">
                    <img width="150" src="imgs/complaints.jpeg" /><br /><br />
